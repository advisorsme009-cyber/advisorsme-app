    ...
    <ThemeProvider theme={LinkedinAITheme}>
      <Box sx={{ width: '100%', p: 3, bgcolor: '#F5F6F8', minHeight: '100vh' }}>
        ...
        {!loading && charts.length === 0 && !error && (
          <Paper elevation={0} sx={{ p: 6, borderRadius: 3, border: '1px dashed #CBD5E1', textAlign: 'center' }}>
            ...
            <Typography variant="body2" sx={{ color: '#94A3B8', mt: 0.5 }}>
              Go to <strong>API &amp; Metrics</strong>, open a chart, and click “Add to Report Generator”.
            </Typography>
          </Paper>
        )}
        ...
        <Dialog open={Boolean(pendingDelete)} onClose={() => setPendingDelete(null)}>
          ...
          <DialogContent>
            <DialogContentText>
              “{pendingDelete?.title}” will be permanently removed from the Report Generator.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
