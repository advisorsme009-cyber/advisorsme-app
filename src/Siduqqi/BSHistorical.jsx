...
const BSHistorical = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await fetch(
        `${apiUrl}/calculation/BS/historical/lv1/fetch/?client_id=${encodeURIComponent(
          clientId
        )}`,
        {
          method: "GET",
  ...
  const exportData = async () => {
    ...
    try {
      const response = await fetch(
        `${apiUrl}/calculation/BS/historical/lv1/export/?client_id=${encodeURIComponent(
          clientId
        )}`,
        {
          method: "GET",
      ...
      let filename = "BS_historical.xlsx";
