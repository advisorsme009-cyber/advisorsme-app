...
export const dashboardItems = [
  ...
  {
    key: "api_and_metrics",
    title: "API and Metrics",
    description: "Explore metrics, drill into Lv3 breakdowns, and pin charts",
    path: "/ApiAndMetrics",
    icon: InsightsIcon,
    color: "#c2185b",
    show: true,
  ...
  },
  {
    key: "saved_reports",
    title: "Saved Reports",
    description: "Pinned charts with commentary, exportable to PDF",
    path: "/SavedReports",
    icon: DescriptionIcon,
    color: "#1F559B",
    show: true,
  },
  {
    ...
    description: "DCF, sensitivity, and valuation multiples (BV)",
  ...
  },
  {
    ...
    description: "EV/EBITDA scenarios and industry averages (Comps)",
  ...
  },
  {
    ...
    description: "Football-field and weighted fair value (VM)",
  ...
  },
  {
    ...
    description: "Executive dashboard — Income Statement & Balance Sheet KPIs",
