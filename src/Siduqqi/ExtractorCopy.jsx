...
const styleHtmlContent = (htmlString) => {
  ...
  `;
  return style + htmlString;
};

const FinancialStatementUploaderCopy = () => {
  ...
  const handleExtractTables = async () => {
    ...
    if (allTables.length) {
      openSnackbar(`Extracted ${allTables.length} tables!`);
    } else {
      openSnackbar("No tables found.", "info");
    }
    setSelectedFiles([]);
    setIsLoading(false);
  };
  ...
  const theme = createTheme({
    palette: {
      text: {
        ...
        secondary: "#000000", // just in case you use text.secondary
      },
      primary: {
        main: "#FFA500", // orange
      },
    ...
    components: {
      MuiTypography: {
        defaultProps: {
          // make every Typography use text.primary unless overridden
          color: "text.primary",
        },
        variants: [
                      ...
                      <Box
                        sx={{
                          ...
                          "& th, & td": {
                            ...
                            px: 1,
                            py: 0.5,
                            color: "text.primary", // all cells black
                          },
                          "& th": {
                            color: "primary.main", // override headers to orange
                            fontWeight: "bold",
                            backgroundColor: "background.paper",
                          },

                          "& strong": {
                            fontWeight: "bold", // reinforces bold
                            color: "primary.main", // orange
                          },
                          "& u": {
                            textDecoration: "underline", // reinforce the underline
                            color: "text.primary", // keep it black
                            fontStyle: "italic", // optional flair
                          },

                          "& ins": {
                            textDecoration: "underline",
                            color: "primary.main", // maybe make <ins> orange
                            backgroundColor: "background.paper",
                          },
                        }}
...
export default FinancialStatementUploaderCopy;
